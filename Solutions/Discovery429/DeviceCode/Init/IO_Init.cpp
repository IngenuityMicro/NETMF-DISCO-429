...
//  Implementation for the Discovery429 board (STM32F4): Copyright (c) Oberon microsystems, Inc.
//
//  *** Discovery429 Board Specific IO Port Initialization ***
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void __section(SectionForBootstrapOperations) Discovery429_InitSRam() {
...
void __section(SectionForBootstrapOperations) BootstrapCode_GPIO() {
    ...
    CPU_GPIO_EnableOutputPin(6 * 16 + 13, FALSE); // PG13 = LED1
    CPU_GPIO_EnableOutputPin(6 * 16 + 14, FALSE); // PG14 = LED2

    Discovery429_InitSRam(); // initialize FMC
}
