...
BOOL CPU_SPI_Xaction_Start( const SPI_CONFIGURATION& Configuration )
{
...
#ifdef STM32F4XX
    case 3: RCC->APB2ENR |= RCC_APB2ENR_SPI4EN; break; // enable SPI4 clock
    case 4: RCC->APB2ENR |= RCC_APB2ENR_SPI5EN; break; // enable SPI5 clock
    case 5: RCC->APB2ENR |= RCC_APB2ENR_SPI6EN; break; // enable SPI6 clock
#endif
    }
    ...
    if (Configuration.SPI_mod == 2 && mosi != 54) alternate = 0x262; // SPI3 on AF6
...
#ifdef STM32F4XX
    case 3: RCC->APB2ENR &= ~RCC_APB2ENR_SPI4EN; break; // disable SPI4 clock
    case 4: RCC->APB2ENR &= ~RCC_APB2ENR_SPI5EN; break; // disable SPI5 clock
    case 5: RCC->APB2ENR &= ~RCC_APB2ENR_SPI6EN; break; // disable SPI6 clock
#endif
    }
