...
static void (*receiveIntHandler)(void);

//--------------------------------------------------------------------------------------------
// Local functions declarations
//--------------------------------------------------------------------------------------------

static void enableDmaInterrupts(void);
static void disableDmaInterrupts(void);
static void flushTxFifo(void);
static void initMACCR(void);
static void initMACFFR(void);
static void initMACMIIAR(void);
static void initMACFCR(void);
static void initMACIMR(void);
static void initDMABMR(void);
static void initDMAOMR(void);
 ...
 */
void eth_initDmaMacRegisters(void)
{
 ...
 */
void eth_dmaInterruptHandler(void)
{
...
static void initMACFFR(void)
{
    ...
    ETH->MACFFR |=  ETH_MACFFR_PAM;             // Pass all multicast enabled
